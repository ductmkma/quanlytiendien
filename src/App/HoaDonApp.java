...
public class HoaDonApp {
    ...
    public String nhapThoiGian() {
        ...
        String time;
        do {
            System.out.print("Mời bạn nhập tháng_năm muốn xem HĐ(VD: 9_2018): ");
            time = sc.nextLine();
    ...
    public void capNhatTrangThaiCSDDaCoHoaDon(String maKH, String time) {
        String arr[] = time.split("_");
        ChiSoDienApp csdApp = new ChiSoDienApp();
        csdApp.docChiSoDienThangHienTai(arr[0], arr[1]);
        for (int i = 0; i < csdApp.listCSDThangHienTai.size(); i++) {
    ...
    public void inHoaDonChiTiet() {
        ...
        if (!file.exists()) {
            ...
            docFileHoaDon(time);
            System.out.print("Mời bạn nhập mã khách hàng cần xem: ");
            ...
            for (int i = 0; i < listHoaDon.size(); i++) {
                ...
                if (maKH.equals(hd.getMaKH())) {
                    ...
                    System.out.println("| SĐT: 0868 901 456   Email: info@zent.vn                                              |");
                    System.out.printf("| Mã hóa đơn: %-11s                                                 |\n", hd.getMaHD());
                    System.out.printf("| Mã khách hàng: %-11s                                                           |\n", kh.getMaKH());
                    ...
                    System.out.println("+---------------+-----------------+----------------+-------------------+---------------+");
                    System.out.printf("|%15d|", csd.getChiSoCu());
                    System.out.printf("%17d|", csd.getChiSoMoi());
